        ...
        <section className="rooms container">
            ...
            <div className="rooms__head flex__between">
                <div className="flex__between">
                    ...
                    <div className="rooms__inputBox" onClick={() => inputRef.current.focus()}>
                        <MdSearch />
                        <input ref={inputRef} type="text" className="rooms__input" />
                    </div>
                </div>
                <button className="btnprimary rooms__button" onClick={() => setShowModal(true)} >
                    <MdRecordVoiceOver />
