...
import { FaArrowLeft, FaHandPeace, FaHandScissors, FaMicrophone } from "react-icons/fa"
            ...
            <div className="singleRoom__users">
                <div className="container">
                    <div className="top">
                        ...
                        <div className="right">
                            <button><FaHandPeace /></button>
                            <Link to="/rooms">
                                <button>
                                    <FaHandScissors />leave quitely
                                </button>
                            </Link>
                        </div>
                    </div>
                    <div className="singleRoom__clients">
                        {clients.map(client => (
                            <div key={client.id} className="singleRoom__client" >
                                ...
                                <div className="img">
                                    <ImageWithBorder src={client.userAvatar} big={true} color={colors[getColor()]} />
                                    <div className="micContainer" onClick={() => handleMuteClick(client.id)}>
